...
def run_diagnosis(user_message: str, image_b64: str | None, city: str) -> tuple[str, str]:
    ...
    if image_b64 is not None:
        ...
        vision_prompt = (
            ...
            "WHEN TWO SPECIES LOOK SIMILAR:\n"
            "• Use the visual differentiators in your knowledge to pick the most likely one.\n"
            "• If still unsure, name the most likely candidate first, then ask ONE specific\n"
            "  visual question to confirm. Never ask more than one question.\n"
            "• Always commit to a primary answer before asking anything.\n\n"
